...
parser.add_argument('--provider',default='sambanova',type=str,help='your provider here', choices=['cohere', 'openai', 'sambanova', 'gemini', 'groq'])
...
if __name__ == "__main__":
    ...
    for line in (open(path)):
        ...
        test_bot.update_query(user_input)
        result = test_bot.generate()
        tmp = {'input':query,'result':result}
